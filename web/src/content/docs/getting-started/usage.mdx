...
If you have [logging extras](../reference/logger-options.mdx/#log-extras) enabled, DogLog can automatically log data from the PDP/PDH like battery voltage, device currents, etc.
...
```java {3-5,22-23} title="RobotContainer.java"
package frc.robot;
