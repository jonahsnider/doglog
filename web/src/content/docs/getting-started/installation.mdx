...
1. Open the WPILib command palette
   ![Screenshot of button to open the WPILib command palette](../../../assets/guides/install/command-palette.png)
2. Select "Manage Vendor Libraries"
   ![Screenshot of the "Manage Vendor Libraries" option in the WPILib command palette](../../../assets/guides/install/manage-vendor-libraries.png)
3. Select "Install new libraries (online)"
   ![Screenshot of the "Install new libraries (online)" option in the WPILib command palette](../../../assets/guides/install/install-new-libraries.png)
4. Paste the vendordep URL from the codeblock above
   ![Screenshot of the vendordep URL being pasted into the WPILib vendordeps dialog](../../../assets/guides/install/vendordep-url.png)
